...
/// 🧠 OpenAI Service: The industry standard for flexible AI tasks
class OpenAIService extends AIProvider {
  final dio.Dio _dio = dio.Dio();
  final String? baseUrl;
  final String defaultModel;

  OpenAIService({this.baseUrl, this.defaultModel = 'gpt-4o'});
  ...
  Future<AiResult> generateText(String prompt,
    ...
    final url = "${customEndpoint ?? (baseUrl ?? 'https://api.openai.com/v1')}/chat/completions";
    ...
    try {
      ...
      if (e.type == dio.DioExceptionType.cancel) {
        throw Exception("🚫 تم إلغاء طلب OpenAI.");
      }
      throw Exception("OpenAI Connection Error: $e");
    }
  }
